...
3. 撮影直後に写真と音を一体で確認できる **Memory Scene** レビュー
4. `Vision` / `Speech` / 軽量音声解析を使った自動タグ付け
5. 場所ラベル、時間帯の雰囲気、波形フィンガープリントを使った atmospheric metadata
6. ライブラリ一覧、詳細表示、音声再生、編集、削除
7. タイトル / メモ / タグ / 文字起こし / ムード / 場所を横断する検索
